	...
	<div class="row justify-content-center">
		<div class="col-12 col-md-8 col-lg-6">
			...
			<p>
				...
				map where you found the trash, upload a photo of the trash, and provide
				some additional information about the trash that will help us to clean
				it up.
			</p>
			<p>
				Click <em>Next</em> to get started.
			</p>
		</div>
	</div>
)
